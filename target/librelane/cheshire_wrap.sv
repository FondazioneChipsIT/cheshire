...
endpackage // carfield_configuration
...
module cheshire_wrap import cheshire_pkg::*; #(
  ...
  input  axi_mst_req_t [iomsb(DutCfg.AxiExtNumMst):0] axi_ext_mst_req_i,
  output axi_mst_rsp_t [iomsb(DutCfg.AxiExtNumMst):0] axi_ext_mst_rsp_o,
  output axi_slv_req_t [iomsb(DutCfg.AxiExtNumSlv):0] axi_ext_slv_req_o,
  input  axi_slv_rsp_t [iomsb(DutCfg.AxiExtNumSlv):0] axi_ext_slv_rsp_i,
  // External reg demux slaves
  output reg_req_t [iomsb(DutCfg.RegExtNumSlv):0] reg_ext_slv_req_o,
  input  reg_rsp_t [iomsb(DutCfg.RegExtNumSlv):0] reg_ext_slv_rsp_i,
  // Interrupts from and to external targets
  input  logic [iomsb(DutCfg.NumExtInIntrs):0]                                   intr_ext_i,
  output logic [iomsb(DutCfg.NumExtOutIntrTgts):0][iomsb(DutCfg.NumExtOutIntrs):0]  intr_ext_o,
  // Interrupt requests to external harts
  output logic [iomsb(NumIrqCtxts*DutCfg.NumExtIrqHarts):0] xeip_ext_o,
  output logic [iomsb(DutCfg.NumExtIrqHarts):0]             mtip_ext_o,
  output logic [iomsb(DutCfg.NumExtIrqHarts):0]             msip_ext_o,
  // Debug interface to external harts
  output logic                                dbg_active_o,
  output logic [iomsb(DutCfg.NumExtDbgHarts):0]  dbg_ext_req_o,
  input  logic [iomsb(DutCfg.NumExtDbgHarts):0]  dbg_ext_unavail_i,
  // JTAG interface
  ...
  output logic [DutCfg.VgaRedWidth  -1:0]  vga_red_o,
  output logic [DutCfg.VgaGreenWidth-1:0]  vga_green_o,
  output logic [DutCfg.VgaBlueWidth -1:0]  vga_blue_o,
  // USB interface
...
endmodule // wrapper_cheshire_soc
