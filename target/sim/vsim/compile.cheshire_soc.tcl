...
set ROOT "/data/ytortorella/emulator/tender-release/cheshire"
...
vlog "/data/ytortorella/emulator/tender-release/cheshire/target/sim/src/elfloader.cpp" -ccflags "-std=c++11" -cpppath "/usr/lib64/ccache/g++"
