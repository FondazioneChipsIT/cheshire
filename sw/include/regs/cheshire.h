...
#define CHESHIRE_HW_FEATURES_CORE_TYPE_MASK 0x3
#define CHESHIRE_HW_FEATURES_CORE_TYPE_OFFSET 14
#define CHESHIRE_HW_FEATURES_CORE_TYPE_FIELD \
  ((bitfield_field32_t) { .mask = CHESHIRE_HW_FEATURES_CORE_TYPE_MASK, .index = CHESHIRE_HW_FEATURES_CORE_TYPE_OFFSET })
