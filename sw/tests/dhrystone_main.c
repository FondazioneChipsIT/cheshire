...
*/
  ...
  //while (!Done) {
    ...
    __asm__ volatile("csrw mhpmevent3, %0" :: "r"(0b00101)); // loads
    __asm__ volatile("csrw mhpmevent4, %0" :: "r"(0b00110)); // stores
    __asm__ volatile("csrw mhpmevent5, %0" :: "r"(0b01001)); // branchs
    __asm__ volatile("csrw mhpmevent6, %0" :: "r"(0b01010)); // misspredicts
    __asm__ volatile("csrw mhpmevent7, %0" :: "r"(0b00001)); // I$ misses
    __asm__ volatile("csrw mhpmevent8, %0" :: "r"(0b00010)); // D$ misses
    ...
    __asm__ volatile("csrw mhpmevent3, %0" :: "r"(0b00000));
    __asm__ volatile("csrw mhpmevent4, %0" :: "r"(0b00000));
    __asm__ volatile("csrw mhpmevent5, %0" :: "r"(0b00000));
    __asm__ volatile("csrw mhpmevent6, %0" :: "r"(0b00000));
    __asm__ volatile("csrw mhpmevent7, %0" :: "r"(0b00000)); 
    __asm__ volatile("csrw mhpmevent8, %0" :: "r"(0b00000)); 
...
*/
  ...
  DMIPS = ((Number_Of_Runs * 1000000) / (User_Time)) / 1757;
